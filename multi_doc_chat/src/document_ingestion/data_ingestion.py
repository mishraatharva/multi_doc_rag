...
# from langchain.schema import Document # old
...
class ChatIngestor:
    def __init__( self,
        temp_base: str = "data", # temp directory from where data will get store in vector db
        faiss_base: str = "faiss_index", # where vector db will get store itself
