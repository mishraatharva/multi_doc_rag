...
from fastapi.testclient import TestClient # used to run fast_api server with acctually running the server.
...
@pytest.fixture # reusable are reusable fn what to available for testing environment.
def client():
...
def stub_model_loader(monkeypatch):
    ...
    # import multi_doc_chat.utils as ml_mod
